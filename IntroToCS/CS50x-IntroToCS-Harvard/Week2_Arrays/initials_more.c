...
IMPORTANT NOTE
---------------
This is EXACTLY the same code as initials_less.c
My solution the the less comfortable version of problem was robust enough to solve this version as well.
